...
final materialXTheme = XThemeData(
  colors: {
    ...
    $material.colorScheme.onSecondary:
        ColorResolver((c) => c.color.onSecondary),
  ...
  textStyles: {
    ...
    $material.textTheme.headline1:
        TextStyleResolver((c) => c.text.displayLarge!),
    $material.textTheme.headline2:
        TextStyleResolver((c) => c.text.displayMedium!),
    $material.textTheme.headline3:
        TextStyleResolver((c) => c.text.displaySmall!),
    $material.textTheme.headline4:
        TextStyleResolver((c) => c.text.headlineMedium!),
    $material.textTheme.headline5:
        TextStyleResolver((c) => c.text.headlineSmall!),
    $material.textTheme.headline6: TextStyleResolver((c) => c.text.titleLarge!),
    $material.textTheme.subtitle1:
        TextStyleResolver((c) => c.text.titleMedium!),
